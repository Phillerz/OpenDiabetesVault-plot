...
public class PlotteriaConfig {
    ...
    private double bolusClassificationMinutes = 240.0;
    ...
    private boolean plotBolusClassification = true;
    private boolean plotBolusClassificationClass1 = true;
    private boolean plotBolusClassificationClass2 = true;
    private boolean plotBolusClassificationClass3 = true;
    private boolean plotBolusClassificationClass4 = true;
    private boolean plotBolusClassificationClass5 = true;
    private boolean plotBolusClassificationClass6 = true;
    ...
    private String bolusClassificiationColorClass1 = "#CC0006";
    private String bolusClassificiationColorClass2 = "#7F2F31";
    private String bolusClassificiationColorClass3 = "#FF0007";
    private String bolusClassificiationColorClass4 = "#FF4C52";
    private String bolusClassificiationColorClass5 = "#7F0004";
    private String bolusClassificiationColorClass6 = "#7F1619";
    ...
    private String bolusCalculationLegend = "bolus calculation";
    ...
    private String plotListFileDailyStatistics = "tex_g_plotListDailyStatistics.tex";
    ...
    private String headerFileDailyStatistics = "tex_g_headerDailyStatistics.tex";
    ...
    private String legendFileSeperate = "legendSeperate.pdf";
    ...
    // generics
    private List<Generic> cgmGenerics = new ArrayList<Generic>();
    private List<Generic> bolusCalculationGenerics = new ArrayList<Generic>();
    private List<Generic> bolusGenerics = new ArrayList<Generic>();
    private List<Generic> basalGenerics = new ArrayList<Generic>();
	...
	public double getBolusClassificationMinutes() {
		return bolusClassificationMinutes;
	}
	public void setBolusClassificationMinutes(double bolusClassificationMinutes) {
		this.bolusClassificationMinutes = bolusClassificationMinutes;
	}
	...
	public boolean isPlotBolusClassification() {
		return plotBolusClassification;
	}
	public void setPlotBolusClassification(boolean plotBolusClassification) {
		this.plotBolusClassification = plotBolusClassification;
	}
	public boolean isPlotBolusClassificationClass1() {
		return plotBolusClassificationClass1;
	}
	public void setPlotBolusClassificationClass1(
			boolean plotBolusClassificationClass1) {
		this.plotBolusClassificationClass1 = plotBolusClassificationClass1;
	}
	public boolean isPlotBolusClassificationClass2() {
		return plotBolusClassificationClass2;
	}
	public void setPlotBolusClassificationClass2(
			boolean plotBolusClassificationClass2) {
		this.plotBolusClassificationClass2 = plotBolusClassificationClass2;
	}
	public boolean isPlotBolusClassificationClass3() {
		return plotBolusClassificationClass3;
	}
	public void setPlotBolusClassificationClass3(
			boolean plotBolusClassificationClass3) {
		this.plotBolusClassificationClass3 = plotBolusClassificationClass3;
	}
	public boolean isPlotBolusClassificationClass4() {
		return plotBolusClassificationClass4;
	}
	public void setPlotBolusClassificationClass4(
			boolean plotBolusClassificationClass4) {
		this.plotBolusClassificationClass4 = plotBolusClassificationClass4;
	}
	public boolean isPlotBolusClassificationClass5() {
		return plotBolusClassificationClass5;
	}
	public void setPlotBolusClassificationClass5(
			boolean plotBolusClassificationClass5) {
		this.plotBolusClassificationClass5 = plotBolusClassificationClass5;
	}
	public boolean isPlotBolusClassificationClass6() {
		return plotBolusClassificationClass6;
	}
	public void setPlotBolusClassificationClass6(
			boolean plotBolusClassificationClass6) {
		this.plotBolusClassificationClass6 = plotBolusClassificationClass6;
	}
	...
	public String getBolusClassificiationColorClass1() {
		return bolusClassificiationColorClass1;
	}
	public void setBolusClassificiationColorClass1(
			String bolusClassificiationColorClass1) {
		this.bolusClassificiationColorClass1 = bolusClassificiationColorClass1;
	}
	public String getBolusClassificiationColorClass2() {
		return bolusClassificiationColorClass2;
	}
	public void setBolusClassificiationColorClass2(
			String bolusClassificiationColorClass2) {
		this.bolusClassificiationColorClass2 = bolusClassificiationColorClass2;
	}
	public String getBolusClassificiationColorClass3() {
		return bolusClassificiationColorClass3;
	}
	public void setBolusClassificiationColorClass3(
			String bolusClassificiationColorClass3) {
		this.bolusClassificiationColorClass3 = bolusClassificiationColorClass3;
	}
	public String getBolusClassificiationColorClass4() {
		return bolusClassificiationColorClass4;
	}
	public void setBolusClassificiationColorClass4(
			String bolusClassificiationColorClass4) {
		this.bolusClassificiationColorClass4 = bolusClassificiationColorClass4;
	}
	public String getBolusClassificiationColorClass5() {
		return bolusClassificiationColorClass5;
	}
	public void setBolusClassificiationColorClass5(
			String bolusClassificiationColorClass5) {
		this.bolusClassificiationColorClass5 = bolusClassificiationColorClass5;
	}
	public String getBolusClassificiationColorClass6() {
		return bolusClassificiationColorClass6;
	}
	public void setBolusClassificiationColorClass6(
			String bolusClassificiationColorClass6) {
		this.bolusClassificiationColorClass6 = bolusClassificiationColorClass6;
	}
	...
	public String getBolusCalculationLegend() {
		return bolusCalculationLegend;
	}
	public void setBolusCalculationLegend(String bolusCalculationLegend) {
		this.bolusCalculationLegend = bolusCalculationLegend;
	}
	...
	public String getPlotListFileDailyStatistics() {
		return plotListFileDailyStatistics;
	}
	public void setPlotListFileDailyStatistics(String plotListFileDailyStatistics) {
		this.plotListFileDailyStatistics = plotListFileDailyStatistics;
	}
	...
	public String getHeaderFileDailyStatistics() {
		return headerFileDailyStatistics;
	}
	public void setHeaderFileDailyStatistics(String headerFileDailyStatistics) {
		this.headerFileDailyStatistics = headerFileDailyStatistics;
	}
	...
	public String getLegendFileSeperate() {
		return legendFileSeperate;
	}
	public void setLegendFileSeperate(String legendFileSeperate) {
		this.legendFileSeperate = legendFileSeperate;
	}
	...
	public List<Generic> getCgmGenerics() {
		return cgmGenerics;
	}
	public void setCgmGenerics(List<Generic> cgmGenerics) {
		this.cgmGenerics = cgmGenerics;
	}
	public List<Generic> getBolusCalculationGenerics() {
		return bolusCalculationGenerics;
	}
	public void setBolusCalculationGenerics(List<Generic> bolusCalculationGenerics) {
		this.bolusCalculationGenerics = bolusCalculationGenerics;
	}
	public List<Generic> getBolusGenerics() {
		return bolusGenerics;
	}
	public void setBolusGenerics(List<Generic> bolusGenerics) {
		this.bolusGenerics = bolusGenerics;
	}
	public List<Generic> getBasalGenerics() {
		return basalGenerics;
	}
	public void setBasalGenerics(List<Generic> basalGenerics) {
		this.basalGenerics = basalGenerics;
	}
}
